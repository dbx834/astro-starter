...
/**
 * PasswordInput2 — ShadCN + Formik (confirm password)
 *
 * Props:
 *  - form: Formik bag (required)
 *  - name: field name (default: 'password2')
 *  - id: html id (defaults to name)
 *  - label: boolean|string (true -> "Repeat Password", string -> custom, false -> no label)
 *  - placeholder: boolean|string (true -> "Repeat password", string -> custom, false -> '')
 *  - required: boolean
 *  - showToggle: boolean (default true)
 *  - className: container classes
 *  - style: inline style object (preserved from original)
 */
